...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"tourism-plan","description":"tourism-plan","base":"/Tourism-plan/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"logo":"/logo.svg","nav":[{"text":"首页","link":"/"},{"text":"旅游城市","items":[{"text":"杭州","link":"/views/Hangzhou/"},{"text":"南京","link":"/views/Nanjing/"},{"text":"厦门","link":"/views/Xiamen/"},{"text":"上饶","link":"/views/Shangrao/"},{"text":"武汉","link":"/views/Wuhan/"},{"text":"长沙","link":"/views/Changsha/"},{"text":"重庆","link":"/views/Chongqing/"},{"text":"南昌","link":"/views/Nanchang/"}]},{"text":"登机指南","link":"/views/BoardingGuide/"}],"sidebar":[{"text":"旅游城市","collapsed":false,"items":[{"text":"杭州","link":"/views/Hangzhou/"},{"text":"南京","link":"/views/Nanjing/"},{"text":"厦门","link":"/views/Xiamen/"},{"text":"上饶","link":"/views/Shangrao/"},{"text":"武汉","link":"/views/Wuhan/"},{"text":"长沙","link":"/views/Changsha/"},{"text":"重庆","link":"/views/Chongqing/"},{"text":"南昌","link":"/views/Nanchang/"}]},{"text":"乘机指南（国内）","items":[{"text":"登机指南","link":"/views/BoardingGuide/"}]}],"footer":{"message":"山海自有归期 风雨自有相逢.","copyright":"意难平终将和解 万事终将顺意"},"search":{"provider":"local"},"outline":{"level":[2,6],"label":"目录"}},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
var define_import_meta_env_default = { BASE_URL: "/Tourism-plan/", MODE: "production", DEV: false, PROD: true, SSR: true };
